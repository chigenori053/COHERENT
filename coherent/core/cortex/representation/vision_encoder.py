...
from coherent.core.cortex.memory.data_types import HolographicTensor, SpectrumConfig
from coherent.core.cortex.representation.base import IHolographicEncoder
