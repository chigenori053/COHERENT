...
from coherent.core.holographic.data_types import HolographicTensor, SpectrumConfig
from coherent.core.multimodal.base_encoder import IHolographicEncoder
